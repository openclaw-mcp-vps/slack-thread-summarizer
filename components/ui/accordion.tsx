  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "flex flex-1 items-center justify-between py-4 text-left text-sm font-semibold text-slate-100 transition-all hover:text-sky-300 [&[data-state=open]>svg]:rotate-180",
          className,
        )}
        {...props}
      >
